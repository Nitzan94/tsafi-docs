...
export const Navigation: React.FC = () => {
  ...
  // ניהול נייד
  const { isSidebarOpen, closeSidebar, isMobile } = useMobileNavigation();
    ...
    <>
      ...
      <nav 
        ...
        className={cn(
          ...
          // Desktop: תמיד גלוי, רוחב מלא
          "lg:translate-x-0 lg:w-72 lg:z-40",
          // Mobile: תלוי במצב, רוחב מותאם
          isMobile 
            ? cn(
                "w-80 z-50", // רחב יותר בנייד לנוחות
      ...
      >
        ...
        {/* הערות מהירות */}
        <div className={cn(
          "mt-6 border-t border-gray-100 bg-gray-50",
          isMobile ? "px-6 py-4" : "px-8 py-6"
        )}>
